...
export const CTA: FC<CTAData> = (props) => {
  const {
    ...
    description = "With VibeCape, you can quickly build modern full-stack applications. Integrated with the latest tech stack, let you focus on business logic implementation.",
  } = props;
  return (
