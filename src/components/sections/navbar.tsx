...
export function Navbar() {
  ...
  return (
    <header
      className={
        `sticky top-0 z-50 w-full transition-colors duration-200 ${scrolled ? "bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60 shadow-lg" : "bg-transparent"}`
      }
    >
        ...
        <nav className="hidden justify-between lg:flex">
          <div className="flex items-center gap-6">
            ...
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-xl font-semibold tracking-tight">vibetake</span>
            </Link>
