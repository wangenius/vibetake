...
import { Clock, Database, Key, Shield, Users } from "lucide-react";
import Link from "next/link";
import { Badge } from "@/components/ui/badge";
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card";
import { db } from "@/services/database/client";
import { account, session, user, verification } from "@/services/database/schema";
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">管理和监控应用程序的数据库表和数据</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>常用的数据库管理操作</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>数据库和系统运行状态</CardDescription>
          </CardHeader>
          <CardContent>
