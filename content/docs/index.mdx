...
```bash
# 克隆模板仓库
git clone https://github.com/wangenius/vibetake.git my-project

# 进入项目目录
cd my-project

# 自行配置环境（基于pre.sh 可以参考）
# 启动开发服务器
npm run dev
```
...
1. 访问 [GitHub 仓库](https://github.com/wangenius/vibetake)
